...
import { Tabs,Input,Icon,Affix,Carousel ,Modal,Button,Card,Spin} from 'ant-design-vue'


Vue.use(Tabs).use(Input).use(Icon).use(Affix).use(Carousel).use(Button).use(Card).use(Spin);
